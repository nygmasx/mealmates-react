function Home() {
    return (
        <div className="font-inter">
            {/* En-tête du site */}
            <header
                className="min-h-screen bg-[url('/public/header-background.png')] bg-center bg-cover bg-no-repeat relative">
                        ...
                        <div className="flex flex-col lg:flex-row items-center">
                            ...
                            <div className="w-full lg:w-2/3 text-center lg:text-left mb-5 lg:mb-0">
                                <h1 className="mb-4 text-4xl md:text-5xl lg:text-6xl font-bold">
                                    Donnez vos repas,<br className="hidden lg:block"></br> au lieu de les <span
                                    className="text-[#53B175]">Gaspiller</span>
                                </h1>
                                <p className="text-[#53B175] my-4">
                                    Mealmate est une plateforme qui vous permet de donner vos repas non consommés à des
                                    personnes dans le besoin.
                                </p>
                                <button
                                    className="bg-[#53B175] text-white px-6 py-3 rounded hover:bg-opacity-90 transition-all font-medium mt-4">S'inscrire
                                </button>
                            </div>

                            {/* Image de l'application mobile */}
                            <div className="w-full lg:w-1/2 text-center">
                                <img className="max-w-4/5 inline-block" src="../../public/mobile.png"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-center">
                            <div className="mb-5">
                                ...
                                <p className="opacity-75 px-2 md:px-4">
                                    Transformez vos surplus culinaires en opportunités de partage avec votre communauté
                                    locale et réduisez le gaspillage alimentaire tout en valorisant vos talents de
                                    cuisinier.
                                </p>
                            </div>
                            <div className="mb-5">
                                ...
                                <p className="opacity-75 px-2 md:px-4">
                                    Explorez une diversité de plats préparés par vos voisins, découvrez de nouvelles
                                    cuisines et savourez des repas authentiques que vous ne trouverez pas ailleurs.
                                </p>
                            </div>
                            <div className="mb-5">
                                ...
                                <p className="opacity-75 px-2 md:px-4">
                                    Accédez à des plats délicieux à prix réduits tout en permettant aux cuisiniers
                                    amateurs de rentabiliser leurs préparations en trop.
                                </p>
                            </div>

                            <div className="mb-5">
                                <img className="mx-auto mb-4" src="../../public/fa-solid_hands-helping.png"
                                     alt="fonctionnalité"/>
                                <h3 className="text-xl md:text-2xl font-bold">Créez des liens dans votre quartier</h3>
                                <p className="opacity-75 px-2 md:px-4">
                                    Rencontrez les passionnés de cuisine autour de chez vous, échangez autour d'une
                                    passion commune et tissez des liens authentiques dans votre communauté.
                                </p>
                            </div>
                            <div className="mb-5">
                                <img className="mx-auto mb-4" src="../../public/fa6-solid_earth-africa.png"
                                     alt="fonctionnalité"/>
                                <h3 className="text-xl md:text-2xl font-bold">Préservez notre planète</h3>
                                <p className="opacity-75 px-2 md:px-4">
                                    Chaque repas partagé sur MealMates représente un geste concret pour l'environnement
                                    en limitant le gaspillage alimentaire et l'empreinte carbone liée à la production
                                    alimentaire.
                                </p>
                            </div>
                            <div className="mb-5">
                                <img className="mx-auto mb-4" src="../../public/Base_feature_icon.png"
                                     alt="fonctionnalité"/>
                                <h3 className="text-xl md:text-2xl font-bold">Simplifiez votre quotidien</h3>
                                <p className="opacity-75 px-2 md:px-4">
                                    Une interface intuitive pour proposer ou trouver des plats près de chez vous, des
                                    paiements sécurisés et un système d'évaluation transparent pour des échanges en
                                    toute confiance.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col lg:flex-row">
                            <div className="w-full lg:w-5/12 mb-5 lg:mb-0">
                                <div className="relative mb-5">
                                    <img className="hidden lg:block absolute -top-10 -left-20"
                                         src="../../public/quote_mark.png"/>
                                    <h4 className="font-bold mb-2 text-2xl md:text-3xl">Témoignages de clients
                                        réels</h4>
                                ...
                                <div className="bg-gray-700 rounded-lg p-6 md:p-8 mb-6">
                                    ...
                                    <div className="relative pt-2">
                                        ...
                                        <p className="pl-4">
                                            Pour démarrer rapidement la conception de la page d'accueil de ma startup,
                                            je cherchais un kit UI. MealMates est l'un des meilleurs kits UI que j'ai pu
                                            trouver. Il est flexible, bien organisé et facilement modifiable.
                                        </p>
                                        ...
                                        <div className="bg-gray-700 rounded-lg p-6 md:p-8">
                                            ...
                                            <div className="relative pt-2">
                                                <img className="absolute top-0 left-0"
                                                     src="../../public/small_quote_mark.png"/>
                                                <p className="pl-4">
                                                    J'ai utilisé MealMates et créé une page d'accueil pour ma startup en
                                                    une semaine. Le kit UI de MealMates est simple et très intuitif,
                                        ...
                                        <div className="bg-gray-700 rounded-lg p-5">
                                            ...
                                            <div className="relative pt-2">
                                                <img className="absolute top-0 left-0"
                                                     src="../../public/small_quote_mark.png"/>
                                                <p className="pl-4">
                                                    MealMates nous a fait gagner du temps dans la conception de la page
                                                    de notre entreprise.
                                                </p>
                                                <p className="font-bold mt-4">
                    ...
                    <div className="mx-auto max-w-6xl px-4">
                        <div className="flex flex-col lg:flex-row items-center">
                            <div className="w-full lg:w-1/2 mb-5 lg:mb-0">
                                <h4 className="mb-3 text-2xl md:text-3xl font-bold">Connectez-vous avec vos applications
                                    préférées</h4>
                            ...
                            <div className="w-full lg:w-1/2 text-center">
                                <div className="relative">
                                    ...
                                    <img
                                        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-4/5"
                                        src="../../public/vectorLogos.png"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col lg:flex-row items-center">
                            <div className="w-full lg:w-1/2 mb-5 lg:mb-0">
                                <div className="pe-0 lg:pe-5">
                                    <h4 className="font-bold mb-4 text-2xl md:text-3xl">Gérez tous vos restaurants
                                        depuis votre mobile</h4>
                            ...
                            <div className="w-full lg:w-1/2">
                                <div className="flex">
                                    <div className="w-1/2 text-center">
                                        <img className="w-full" src="../../public/phone_mockup_1.png"
                                             alt="maquette téléphone 1"/>
                                    </div>
                                    <div className="w-1/2 text-center mt-0 md:mt-5">
                                        <img className="w-full" src="../../public/phone_mockup_2.png"
                                             alt="maquette téléphone 2"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="w-full lg:w-1/2">
                                <div className="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <div className="w-full sm:w-5/12">
                                        <button
                                            className="w-full bg-[#53B175] text-white p-3 rounded hover:bg-opacity-90 transition-all font-medium">S'abonner
                                        </button>
                                    </div>
                                </div>
                            </div>
