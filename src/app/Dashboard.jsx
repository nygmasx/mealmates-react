      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto py-4 px-6 flex justify-between items-center">
          <div className="flex items-center">
            <img src="/assets/logo-mealmates.png" alt="Logo MealMate" className="h-12" />
          </div>
          <div className="flex items-center space-x-4">
            <span className="text-gray-700">
              {user?.firstName} {user?.lastName}
            </span>
            <Button variant="outline" onClick={logout} className="text-button-green border-button-green">
              Se déconnecter
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto py-6 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow">
              <h2 className="text-lg font-medium text-gray-800 mb-4">Profil utilisateur</h2>
              <div className="space-y-2">
                ...
                <p>
                  <span className="font-medium">Statut:</span> {user?.isVerified ? "Vérifié" : "Non vérifié"}
                </p>
              </div>
            </div>
